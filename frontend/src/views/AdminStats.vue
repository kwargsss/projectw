...
const chartOptions = {
  ...
  plugins: {
    legend: {
      ...
      labels: { color: '#e5e7eb', font: { family: "'Inter', sans-serif", size: 13, weight: 'bold' as const }, usePointStyle: true, boxWidth: 8 }
    },
    tooltip: {
  ...
  scales: {
    ...
    y: {
      grid: { color: 'rgba(75, 85, 99, 0.2)', drawBorder: false },
      ticks: { color: '#9ca3af', font: { family: "'Inter', sans-serif" }, precision: 0 },
      beginAtZero: true
    }
  }
}
    ...
    <div v-if="botStatus === 'online' && stats" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-gray-900/60 backdrop-blur-md border border-gray-800 p-6 rounded-3xl shadow-lg hover:-translate-y-1 transition-all group">
          <div class="flex justify-between items-start mb-4">
            <div class="p-3 bg-green-500/10 rounded-2xl group-hover:bg-green-500/20 transition-colors"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8 text-green-400"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 21v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21m0 0h4.5V3.75M5.25 9h3.75m-3.75 3h3.75m-3.75 3h3.75m3.75-6h3.75m-3.75 3h3.75m-3.75 3h3.75" /></svg></div>
        ...
        <div class="bg-gray-900/60 backdrop-blur-md border border-gray-800 p-6 rounded-3xl shadow-lg hover:-translate-y-1 transition-all group">
          <div class="flex justify-between items-start mb-4">
            <div class="p-3 bg-purple-500/10 rounded-2xl group-hover:bg-purple-500/20 transition-colors"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8 text-purple-400"><path stroke-linecap="round" stroke-linejoin="round" d="M6.75 7.5l3 2.25-3 2.25m4.5 0h3m-9 8.25h13.5A2.25 2.25 0 0 0 21 18V6a2.25 2.25 0 0 0-2.25-2.25H5.25A2.25 2.25 0 0 0 3 6v12a2.25 2.25 0 0 0 2.25 2.25Z" /></svg></div>
          </div>
